document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorContainer(field) {
      ...
      if (id) {
        const explicit = contactForm.querySelector('[data-error-for="' + id + '"]');
        if (explicit) return explicit;
      }
      return field.parentElement.querySelector('.field-error, [data-error]');
    }
    ...
    function validateField(field) {
      ...
      const label =
        ...
        (field.labels && field.labels[0] ? field.labels[0].textContent.trim() : null) ||
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Native form submission (action attribute) or custom fetch
      ...
      if (action && action !== '#') {
        ...
        fetch(action, {
          ...
          .then(function (response) {
            ...
            if (response.ok) {
              ...
              const successMsg = contactForm.querySelector('.form-success, [data-success-message]');
              if (successMsg) {
                successMsg.removeAttribute('hidden');
                successMsg.focus();
              }
            } else {
              const formErrorEl = contactForm.querySelector('.form-error, [data-form-error]');
              if (formErrorEl) {
        ...
        // No action defined — just show success state
        setTimeout(function () {
          contactForm.classList.remove(FORM_SENDING_CLASS);
          contactForm.classList.add(FORM_SUCCESS_CLASS);
          contactForm.reset();
  ...
  const ANIMATE_SELECTOR = '.animate-on-scroll, [data-animate]';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'af1ded0c-308b-49a5-96ba-cd1ec2b85cae',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'af1ded0c-308b-49a5-96ba-cd1ec2b85cae';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'af1ded0c-308b-49a5-96ba-cd1ec2b85cae';
